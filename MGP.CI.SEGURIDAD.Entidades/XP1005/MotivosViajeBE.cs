...
namespace MGP.CI.SEGURIDAD.Entidades.X1005
{
    [DataContract]
    [Serializable]
    public partial class MotivosViajeBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "MotivosViaje";
        [DataMember]
        ...
        public MotivosViajeBE(IDataReader Registro)
        {
