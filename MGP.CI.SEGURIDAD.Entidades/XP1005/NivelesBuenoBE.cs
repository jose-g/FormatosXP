...
namespace MGP.CI.SEGURIDAD.Entidades.X1005
{
    [DataContract]
    [Serializable]
    public partial class NivelesBuenoBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "NivelesBueno";
        [DataMember]
        ...
        public NivelesBuenoBE(IDataReader Registro)
        {
            NivelesBuenoId = ValidarInt(Registro["NivelesBuenoId"]);
