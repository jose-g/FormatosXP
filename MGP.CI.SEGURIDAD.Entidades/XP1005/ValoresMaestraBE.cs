...
namespace MGP.CI.SEGURIDAD.Entidades.X1005
{
    [DataContract]
    [Serializable]
    public partial class ValoresMaestraBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "ValoresMaestra";
        [DataMember]
        ...
        public ValoresMaestraBE(IDataReader Registro)
        {
