...
namespace MGP.CI.SEGURIDAD.Entidades.X1005
{
    [DataContract]
    [Serializable]
    public partial class OpinionMaestraBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "OpinionMaestra";
        [DataMember]
        ...
        public OpinionMaestraBE(IDataReader Registro)
        {
