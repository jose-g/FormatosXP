...
namespace MGP.CI.SEGURIDAD.Entidades.X1005
{
    [DataContract]
    [Serializable]
    public partial class DefectosMaestraBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "DefectosMaestra";
        [DataMember]
        ...
        public DefectosMaestraBE(IDataReader Registro)
        {
