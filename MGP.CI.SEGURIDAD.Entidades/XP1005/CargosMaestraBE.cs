...
namespace MGP.CI.SEGURIDAD.Entidades.X1005
{
    [DataContract]
    [Serializable]
    public partial class CargosMaestraBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "CargosMaestra";
        [DataMember]
        ...
        public CargosMaestraBE(IDataReader Registro)
        {
