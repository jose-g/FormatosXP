...
namespace MGP.CI.SEGURIDAD.Entidades.X1005
{
    [DataContract]
    [Serializable]
    public partial class Observaciones1005TipoBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "Observaciones1005Tipo";
        [DataMember]
        ...
        public Observaciones1005TipoBE() { }
        ...
        public Observaciones1005TipoBE(IDataReader Registro)
        {
