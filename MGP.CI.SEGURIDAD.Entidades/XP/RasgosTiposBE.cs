...
namespace MGP.CI.SEGURIDAD.Entidades
{
    [DataContract]
    [Serializable]
    public partial class RasgosTiposBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "RasgosTipos";
        [DataMember]
        ...
        public RasgosTiposBE(IDataReader Registro)
        {
            RasgoTipoId = ValidarInt(Registro["RasgoTipoId"]);
