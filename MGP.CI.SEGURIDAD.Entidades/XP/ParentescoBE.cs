...
namespace MGP.CI.SEGURIDAD.Entidades
{
    [DataContract]
    [Serializable]
    public partial class ParentescoBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "Parentesco";
        [DataMember]
        ...
        public ParentescoBE(IDataReader Registro)
        {
            ParentescoId = ValidarInt(Registro["ParentescoId"]);
