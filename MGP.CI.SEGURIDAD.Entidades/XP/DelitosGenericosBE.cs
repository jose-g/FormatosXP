...
namespace MGP.CI.SEGURIDAD.Entidades
{
    [DataContract]
    [Serializable]
    public partial class DelitosGenericosBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "DelitosGenericos";
        [DataMember]
        ...
        public DelitosGenericosBE(IDataReader Registro)
        {
