...
namespace MGP.CI.SEGURIDAD.Entidades.XP1003
{
    [DataContract]
    [Serializable]
    public partial class ProfesionesBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "Profesiones";
        [DataMember]
        ...
        public ProfesionesBE(IDataReader Registro)
        {
            ProfesionId = ValidarInt(Registro["ProfesionId"]);
