...
namespace MGP.CI.SEGURIDAD.Entidades.XP1003
{
    [DataContract]
    [Serializable]
    public partial class InstitucionMilitarBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "InstitucionMilitar";
        [DataMember]
        ...
        public InstitucionMilitarBE(IDataReader Registro)
        {
            InstitucionMilitarId = ValidarInt(Registro["InstitucionMilitarId"]);
