...
namespace MGP.CI.SEGURIDAD.Entidades.XP1003
{
    [DataContract]
    [Serializable]
    public partial class VehiculoTiposBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "VehiculoTipos";
        [DataMember]
        ...
        public VehiculoTiposBE(IDataReader Registro)
        {
