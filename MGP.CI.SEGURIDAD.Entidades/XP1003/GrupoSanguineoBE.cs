...
namespace MGP.CI.SEGURIDAD.Entidades.XP1003
{
    [DataContract]
    [Serializable]
    public partial class GrupoSanguineoBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "GrupoSanguineo";
        [DataMember]
        ...
        public GrupoSanguineoBE(IDataReader Registro)
        {
            GrupoSanguineoId = ValidarInt(Registro["GrupoSanguineoId"]);
