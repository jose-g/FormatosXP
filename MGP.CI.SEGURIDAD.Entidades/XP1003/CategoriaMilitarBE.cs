...
namespace MGP.CI.SEGURIDAD.Entidades.XP1003
{
    [DataContract]
    [Serializable]
    public partial class CategoriaMilitarBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "CategoriaMilitar";
        [DataMember]
        ...
        public CategoriaMilitarBE(IDataReader Registro)
        {
            CategoriaMilitarId = ValidarInt(Registro["CategoriaMilitarId"]);
