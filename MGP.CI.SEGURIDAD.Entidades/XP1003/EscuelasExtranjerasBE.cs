...
namespace MGP.CI.SEGURIDAD.Entidades.XP1003
{
    [DataContract]
    [Serializable]
    public partial class EscuelasExtranjerasBE : BaseBE
    {
        #region Propiedades
        public readonly string Table_Name = "EscuelasExtranjeras";
        [DataMember]
        ...
        public EscuelasExtranjerasBE(IDataReader Registro)
        {
